...
class ArticleCategoriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create article_category" do
    assert_difference('ArticleCategory.count') do
      post article_categories_url, params: { article_category: { article_id: @article_category.article_id, category_id: @article_category.category_id } }
    end
  ...
  test "should update article_category" do
    patch article_category_url(@article_category), params: { article_category: { article_id: @article_category.article_id, category_id: @article_category.category_id } }
